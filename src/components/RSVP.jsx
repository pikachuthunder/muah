        ...
        <div className={styles.card}>
          ...
          {submitted ? (
            <div className={styles.success}>
              ...
              <p className={styles.successText}>May Allah bless this beautiful celebration.<br/>We look forward to seeing you on 02 · 08 · 2026 🌹</p>
            </div>
          ) : (
            <div className={styles.formInner}>
              <input className={styles.field} type="text" placeholder="Your Full Name" value={form.name} onChange={e=>update('name',e.target.value)} />
              <input className={styles.field} type="tel" placeholder="Phone Number (optional)" value={form.phone} onChange={e=>update('phone',e.target.value)} />
              ...
              <button className={styles.submit} onClick={handleSubmit}>Send My Response 💌</button>
            </div>
          )}
        </div>
      </div>
